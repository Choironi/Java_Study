...
public ce.class University{ //  클래스 이름 : 일반적으로 첫글자 대문자
...
## 객체 생성 : 클래스로 부터 'new'키워드를 이용해 객체를 생성

```java

package ce;

public ce.class MainClass {
...
값을 설정하는 과정을 객체 생성 과정에서 강제할 수 있음
